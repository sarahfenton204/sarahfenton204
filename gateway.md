...
Welcome! I am a student studying Computer Information Systems at Wayne State College. I'm interested in technology and customer service. This file serves as a central hub for all of my projects. I've been primarily using GitHub for my projects in my Advanced Web Development class, and I have mostly JavaScript in my recorded experience, but I hope to add more as my experience grows!
...
### 📌 Summary
Flashcard Trainer is a simple, browser-based flashcard app that allows users to study using digital flashcards 📚
All flashcards are managed directly in the browser using JavaScript.
...
### 📌 Summary
This is a simple browser-based game where the player tries to guess a randomly generated number between 1 and 100 🎯
...
### 📌 Summary
This project displays an interactive FAQ page for a smartwatch ⌚
...
### 📌 Summary
This is a dynamic web application that calculates and displays a live projection of investment growth over time 📈
